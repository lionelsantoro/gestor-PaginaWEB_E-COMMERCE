      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Almacenamiento:</strong> 2 TB SSD<br>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Medios de pago:</strong> Efectivo, Visa, American Express, Cabal, desde 12 hasta 24 cuotas sin interés.<br>
            <strong>Envío:</strong> Gratis
          </p>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Medios de pago:</strong> Efectivo, American Express, Naranja X, Visa, desde 6 hasta 12 cuotas sin interés.<br>
            <strong>Envío:</strong> Gratis
          </p>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Medios de pago:</strong> Efectivo, Mastercard, Cabal, Visa, desde 6 hasta 12 cuotas sin interés.<br>
            <strong>Envío:</strong> Gratis
          </p>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Medios de pago:</strong> Efectivo, Naranja X, Mastercard, Visa, desde 3 hasta 12 cuotas sin interés.<br>
            <strong>Envío:</strong> Gratis
          </p>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Medios de pago:</strong> Efectivo, Visa, Mastercard, American Express, desde 3 hasta 6 cuotas sin interés.<br>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Almacenamiento:</strong> 2 TB SSD<br>
            <strong>Stock:</strong> 3 disponibles<br>
            <strong>Medios de pago:</strong> Efectivo, Mastercard, Visa, Naranja X, desde 3 hasta 6 cuotas sin interés.<br>
            <strong>Envío:</strong> Gratis
          </p>
        </div>
      </div>
...
<nav aria-label="Navegación de páginas">
  <ul class="pagination justify-content-center mt-5 mb-5">
    ...
    <li class="page-item">
      <a class="page-link" href="/catalogo/computadoras/2">2</a>
    </li>
    
    <li class="page-item">
      <a class="page-link" href="/catalogo/computadoras/2">Siguiente</a>
    </li>
