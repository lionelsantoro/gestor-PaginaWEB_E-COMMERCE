        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="/Imagenes inicio/foto4.png" class="d-block w-100" alt="...">
                </div>
                
                <div class="carousel-item">
                    <img src="/Imagenes inicio/foto5.png" class="d-block w-100" alt="...">
                </div>

                <div class="carousel-item">
                    <img src="/Imagenes inicio/foto6.png" class="d-block w-100" alt="...">
                </div>
                            ...
                            <div class="row row-cols-1 row-cols-md-5 g-3">
                                ...
                                <div class="col">
                                    <div class="card h-100 card-producto p-2">
                                        <div class="bg-light text-center py-5 mb-2 rounded" style="height: 180px;">
                                            <span class="text-muted">Imagen</span>
                                        </div>
                                        <div class="card-body p-2 d-flex flex-column">
                                            <div>
                                                <span class="badge bg-morado mb-2">3 SIN INTERÉS</span>
                                            </div>
                                            <h6 class="card-title text-truncate" style="font-size: 0.9rem;">Nombre del Producto de Ejemplo</h6>
                                            <div class="mt-auto">
                                                <div class="d-flex align-items-center mb-1">
                                                    <span class="precio-tachado me-2">$99.999</span>
                                                    <span class="badge-descuento">10% OFF</span>
                                                </div>
                                                <h5 class="fw-bold mb-3">$89.999</h5>
